...
public final class XCrash {
    ...
    public static synchronized int init(Context ctx, InitParameters params) {
        ...
        if (TextUtils.isEmpty(params.appVersion)) {
            //fixme wyb
            params.appVersion = "999.999"; //Util.getAppVersion(ctx);
        }
...
//        FileManager.getInstance().maintain();
    ...
    public static class InitParameters {
        ...
        ILogger    logger                 = null;
        lib.base.xcrash.ILibLoader libLoader              = null;
         ...
         * @return The InitParameters object.
         */
        public InitParameters setLibLoader(lib.base.xcrash.ILibLoader libLoader) {
        ...
        lib.base.xcrash.ICrashCallback javaCallback                = null;
         ...
         */
        @SuppressWarnings("unused")
        public InitParameters setJavaCallback(lib.base.xcrash.ICrashCallback callback) {
        ...
        lib.base.xcrash.ICrashCallback nativeCallback                = null;
         ...
         */
        @SuppressWarnings("unused")
        public InitParameters setNativeCallback(lib.base.xcrash.ICrashCallback callback) {
        ...
        lib.base.xcrash.ICrashCallback anrCallback          = null;
         ...
         */
        @SuppressWarnings("unused")
        public InitParameters setAnrCallback(lib.base.xcrash.ICrashCallback callback) {
